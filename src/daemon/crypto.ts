 ...
 */
export function exportBundle(secrets: ProfileSecrets, password: string): BackupBundle {
 ...
 */
export function importBundle(bundle: BackupBundle, password: string): ProfileSecrets | null {
  try {
